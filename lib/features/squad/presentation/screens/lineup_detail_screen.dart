              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      context.push('/match-simulation?awayLineupId=${widget.lineupId}');
                    },
                    child: Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          Icon(Icons.sports_soccer_rounded, color: AppColors.gold, size: 24),
                          SizedBox(width: 8),
                          Text(
                            'BU KADROYLA MAÇ YAP',
                            style: TextStyle(
                          ...
                          SizedBox(width: 8),
                          Icon(Icons.local_fire_department_rounded, color: AppColors.gold, size: 24),
                        ],
                      ),
                    ),
                  ),

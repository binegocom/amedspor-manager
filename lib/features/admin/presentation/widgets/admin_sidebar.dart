              ...
              child: ListView(
                children: [
                  ...
                  _SidebarItem(
                    ...
                    title: 'Kalite',
                    active: _isActive('/admin/quality'),
                    onTap: () => context.go('/admin/quality'),
                  ),
                  _SidebarItem(
                    icon: Icons.person_add_rounded,
                    title: 'Oyuncular',
                    active: _isActive('/admin/players'),
                    onTap: () => context.go('/admin/players'),
                  ),
                  _SidebarItem(
                    icon: Icons.groups_rounded,
                    title: 'Kadrolar',
                    active: _isActive('/admin/lineups'),
                    onTap: () => context.go('/admin/lineups'),
                  ),
                  _SidebarItem(
                  ...
                  _SidebarItem(
                    ...
                    title: 'Oyunlaştırma',
                    active: _isActive('/admin/gamification'),
                    onTap: () => context.go('/admin/gamification'),
                  ),
                  _SidebarItem(
                    icon: Icons.add_chart_rounded,
                    title: 'Puan Merkezi',
                    active: _isActive('/admin/points'),
                    onTap: () => context.go('/admin/points'),
                  ),
                  _SidebarItem(
                    icon: Icons.quiz_rounded,
                    title: 'Sorular',
                    active: _isActive('/admin/questions'),
                    onTap: () => context.go('/admin/questions'),
                  ),
                  _SidebarItem(
                    icon: Icons.bug_report_rounded,
                    title: 'Hata Merkezi',
                    active: _isActive('/admin/errors'),
                    onTap: () => context.go('/admin/errors'),
                  ),
                  _SidebarItem(
                    icon: Icons.history_rounded,
                    title: 'Audit Log',
                    active: _isActive('/admin/audit-logs'),
                    onTap: () => context.go('/admin/audit-logs'),
                  ),
                  _SidebarItem(
                    icon: Icons.view_carousel_rounded,
                    title: 'İçerik CMS',
                    active: _isActive('/admin/content'),
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Icon(
                icon,
                color: active ? AppColors.primaryRed : AppColors.muted,
                size: 22,
              ),

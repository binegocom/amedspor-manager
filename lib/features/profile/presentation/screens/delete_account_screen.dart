...
class _DeleteAccountScreenState extends State<DeleteAccountScreen> {
  ...
  Future<void> _deleteAccount() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Hata: Hesabınızı silmek için yakın zamanda giriş yapmış olmalısınız. Lütfen çıkış yapıp tekrar girin.')),
        );
      }
    } finally {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const PremiumHeader(title: 'HESABI SİL', showBackButton: true),
            Expanded(
